...
DATABASES = {
    'default': {
        ...
        'HOST': 'tarkov-django.cdfguq4uldlh.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'tarkov-django-blog' # please enter your s3 bucket name
